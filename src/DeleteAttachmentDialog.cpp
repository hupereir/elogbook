  ...
  CustomDialog( parent )
{
  ...
  group_box->layout()->addWidget( from_disk_radio_button_ = new QRadioButton( "from disk", this ) );
  ...
  group_box->layout()->addWidget( from_logbook_radio_button_ = new QRadioButton( "from dialog", this ) );
