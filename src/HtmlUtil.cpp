...
void HtmlUtil::header( QDomElement& parent, QDomDocument& document )
{
  Debug::Throw( "HtmlUtil::Header.\n" );
...
//_________________________________________
void HtmlUtil::textNode( const string& text, QDomElement& parent, QDomDocument& document )
{
  ...
  {
    parent.appendChild( document.createTextNode( text.substr( begin, end-begin ).c_str() ) );
    parent.appendChild( document.createElement( "br" ) );
    begin = end;
    end = text.find( "\n", begin+1 );
  }
  
  parent.appendChild( document.createTextNode( text.substr( begin, text.size()-begin ).c_str() ) );
  return;
}
