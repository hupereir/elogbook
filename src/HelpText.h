...
static const QString helpText[] =
{
    ...
    //_________________________________________________
    QObject::tr( "Definitions" ),
    QObject::tr( "<h2>Definitions</h2>"
    "<h3>Logbook</h3>"
    ...
    QObject::tr( "<h2>Getting Started</h2>"
    ...
    //_________________________________________________
    QObject::tr( "File Menu" ),
    QObject::tr( "<h2>File Menu</h2>"
    ...
    QObject::tr( "<h2>Settings Menu</h2>"
    ...
    //_________________________________________________
    QObject::tr( "Window Menu" ),
    QObject::tr( "<h2>Window Menu</h2>"
    ...
    //_________________________________________________
    QObject::tr( "Help Menu" ),
    QObject::tr( "<h2>Help Menu</h2>"
    ...
    //_________________________________________________
    QObject::tr( "Keyword/Entry lists" ),
    QObject::tr( "<h2>Keyword/Entry lists</h2>"
    ...
    //_________________________________________________
    QObject::tr( "Entry selection" ),
    QObject::tr( "<h2>Entry Selection</h2>"
    ...
    //_________________________________________________
    QObject::tr( "Edition Window" ),
    QObject::tr( "<h2>Edition Window</h2>"
    ""
